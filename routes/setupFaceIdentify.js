...
// Create, for each person we want to identify, a person within that personGroup and a series images that capture them
// Run Training on the personGroup so that it can be used for identification
